...
module.exports = {
  ...
  execute(message, args, client) {
    ...
    let helpEmbed = new MessageEmbed()
      .setTitle("Samoraii Bot Help")
      .setAuthor('Click here to invite me!!', 'https://i.imgur.com/JT7xPxI.png', 'https://discord.com/api/oauth2/authorize?client_id=1037345041892511805&permissions=8&scope=bot')
      .setDescription(`**PREFIX:** \`${PREFIX}\``)
      .setFooter(client.user.username + `Type: ${PREFIX}help <Command>  for more information!`, "https://i.imgur.com/JT7xPxI.png")
      .setColor("#0b89f3");
