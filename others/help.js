...
module.exports = {
  ...
  execute(message,args,client) {
    ...
    let helpEmbed = new MessageEmbed()
      ...
      .setAuthor('Click here to invite me!!', 'https://media.discordapp.net/attachments/1107674397365506068/1107674419402387497/Untitled-1.png', 'https://discord.com/api/oauth2/authorize?client_id=1037345041892511805&permissions=8&scope=bot')
      .setDescription(`**PREFIX:** \`${PREFIX}\``)
      .setFooter( client.user.username +`Type: ${PREFIX}help <Command>  for more information!`, "https://media.discordapp.net/attachments/1107674397365506068/1107674419402387497/Untitled-1.png")
      .setColor("#0b89f3");
